...
def get_last_read_email():
    if os.path.exists('files/last_read.pickle'):
        with open('files/last_read.pickle', 'rb') as token:
...
def get_messages(service):
    user_id = 'me'
    with open('files/emails.json') as f:
    ...
    with open('files/last_read.pickle', 'wb') as token:
